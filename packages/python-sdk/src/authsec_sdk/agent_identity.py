"""Deprecated path — moved to :mod:`authsec_sdk.identity.agent`.
...
from .identity import agent as _impl

_warnings.warn(
    "authsec_sdk.agent_identity is deprecated; use authsec_sdk.identity "
