...
class WorkloadAPIClient:
    ...
    def __init__(
        ...
        # Last error from a failed fetch — lets callers distinguish
        # "no SVIDs" from connection/protocol failures after a False return.
    ...
    async def fetch_x509_svid_once(self) -> bool:
        ...
        try:
            ...
            if response and len(response.svids) > 0:
                ...
                self.last_error = RuntimeError("no SVIDs in Workload API response")
                return False
